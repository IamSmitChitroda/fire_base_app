...
const int defaulPadding = 16;
const Color primaryColor = Color(0xff4DA04D);
const Color secondaryColor = Color(0xff0D163F);

const String bgPath = 'assets/images/bg.png';
